package com.barataribeiro.sentinelofliberty.repositories.specifications;
...
public class ApplicationSimpleJpaRepository<E, ID extends Serializable> extends SimpleJpaRepository<E, ID>
        implements RepositorySpecificationExecutor<E, ID> {
    private final EntityManager entityManager;
    private final JpaEntityInformation<E, ID> entityInformation;

    public ApplicationSimpleJpaRepository(JpaEntityInformation<E, ID> entityInformation,
