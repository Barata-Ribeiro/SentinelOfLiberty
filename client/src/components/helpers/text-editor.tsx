...
export default function TextEditor({ content, onUpdate }: Readonly<TextEditorProps>) {
    ...
    return (
        <div className="grid w-full gap-4 divide-y divide-stone-200 rounded-md border border-stone-200 bg-transparent p-4 shadow-sm ring ring-transparent transition-all duration-300 ease-in outline-none hover:border-stone-800 hover:ring-stone-300 focus:border-stone-800 focus:ring-stone-300 focus:outline-none">
